<template>
  <button class="theme-toggle" id="theme-toggle" title="Toggles light & dark" aria-label="auto" aria-live="polite" @click="toggleTheme">
...
export default {
  data() {
    return {
      theme: { value: this.getColorPreference() },
    }
  },
  methods: {
    toggleTheme() {
